...
def create_sample_invoice_pdf():
    ...
    invoice_data = PDFInvoiceData(
        ...
        items=[
            ...
            {"description": "Haarpflege Premium", "quantity": 2, "price": 34.50},
        ],
...
def create_no_tax_invoice_pdf():
    ...
    invoice_data = PDFInvoiceData(
        ...
        total_gross=150.00,
        tax_rate=0.00,
        items=[{"description": "Beratungsleistung", "quantity": 3, "price": 50.00}],
    ...
    output_path = os.path.join(
        os.path.dirname(__file__), "test_rechnung_ohne_steuer.pdf"
    )
    with open(output_path, "wb") as f:
        f.write(pdf_bytes)
...
def create_minimal_invoice_pdf():
    ...
    invoice_data = PDFInvoiceData(
        ...
        total_gross=59.50,
        tax_rate=0.19,
        items=[{"description": "Einfache Leistung", "quantity": 1, "price": 59.50}],
