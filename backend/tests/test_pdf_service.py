...
from services.pdf_data_service import PDFDataService, PDFInvoiceData, PDFSummaryInvoiceData
...
class TestPDFDataService:
    ...
    def test_get_invoice_pdf_data_success(self):
        ...
        try:
            ...
            assert pdf_data.date == date(2025, 10, 20)  # Convert expected date to date object
    ...
    def test_get_invoice_pdf_data_calculates_net_amount(self):
        ...
        customer_resp = client.post("/customers/", json={"name": "Net Amount Test Customer"})
        customer_id = customer_resp.json()["id"]
        ...
        try:
            ...
            if invoice["include_tax"]:
                ...
                assert abs((pdf_data.total_net + pdf_data.total_tax) - pdf_data.total_gross) < 0.01
    ...
    def test_get_summary_invoice_pdf_data_success(self):
        ...
        customer_resp = client.post("/customers/", json={"name": "Summary Test Customer Unique"})
        customer_id = customer_resp.json()["id"]
        ...
        pdf_customer_resp = client.post("/customers/", json={
...
class TestPDFServiceEdgeCases:
    ...
    def test_customer_without_address(self):
        ...
        customer_resp = client.post("/customers/", json={"name": "Customer Only Name Unique Test"})
        customer_id = customer_resp.json()["id"]
